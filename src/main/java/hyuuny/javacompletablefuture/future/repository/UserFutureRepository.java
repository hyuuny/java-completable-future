package hyuuny.javacompletablefuture.future.repository;

import hyuuny.javacompletablefuture.common.repository.UserEntity;
...
public class UserFutureRepository {
    ...
    public UserFutureRepository() {
        var user = new UserEntity("1234", "hyuuny", 32, "image#1000");
